...
import type { WAKitEventEmitter, WAKitEventMap, Contact } from '../Types'
...
export type LidMappingUpdateResult = {
	...
	data: WAKitEventMap['lid-mapping.update']
}
...
export const emitSyncActionResults = (ev: WAKitEventEmitter, results: SyncActionResult[]): void => {
