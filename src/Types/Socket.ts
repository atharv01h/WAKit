...
export type SocketConfig = {
	...
	/** should wakit use the mobile api instead of the multi device api
	...
	/** Should WAKit ask the phone for full history, will be received async */
	syncFullHistory: boolean
	/** Should wakit fire init queries automatically, default true */
