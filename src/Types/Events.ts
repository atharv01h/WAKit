...
export type WAKitEvent = keyof WAKitEventMap

export interface WAKitEventEmitter {
	on<T extends keyof WAKitEventMap>(event: T, listener: (arg: WAKitEventMap[T]) => void): void
	off<T extends keyof WAKitEventMap>(event: T, listener: (arg: WAKitEventMap[T]) => void): void
	removeAllListeners<T extends keyof WAKitEventMap>(event: T): void
	emit<T extends keyof WAKitEventMap>(event: T, arg: WAKitEventMap[T]): boolean
}
